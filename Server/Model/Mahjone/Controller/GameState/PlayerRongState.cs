...
namespace ET
{
    public class PlayerRongState : ServerState
    {
        ...
        public override void OnServerStateEnter()
        {
            ...
            //这里强行改变当前玩家.为了后面确定洗牌人
            CurrentRoundStatus.CurrentPlayerIndex = RongPlayerIndices[0];
            // richi-sticks-points
            transfers.Add(new PointTransfer
            {
                From = -1,
            ...
            timerId =TimerComponent.Instance.NewOnceTimer(TimeHelper.ServerNow() + ServerMaxTimeOut * RongPointInfos.Length + ServerConstants.ServerTimeBuffer,TimeoutFunc);
        }
