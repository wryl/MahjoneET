...
namespace ET
{
    ...
    public class MJRoomComponent : Entity
    {
        ...
        {
            var playercomponent=EntityFactory.CreateWithParentAndId<MJRoomPlayerComponent, PlayerInRoom,long>(this,IdGenerater.Instance.GenerateId(), player, GateSessionId);
