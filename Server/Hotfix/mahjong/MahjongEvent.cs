...
namespace ET
{
    ...
    {
        public override async ETTask Run(EventType.ActorMessage arg)
        {
    ...
    {
        public override async ETTask Run(EventType.MessageBroadCast arg)
        {
    ...
    {
        public override async ETTask Run(EventType.GameEnd arg)
        {
            foreach (long actorid in arg.actorIds)
            {
