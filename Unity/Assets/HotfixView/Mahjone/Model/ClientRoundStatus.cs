...
namespace GamePlay.Client.Model
{
	...
	public class ClientRoundStatus : ISubject<ClientRoundStatus>
	{
		...
		public List<Tile> LocalSelectHandTiles
		{
			get;
			private set;
		}
		...
		public ClientRoundStatus(int playerIndex, GameSetting gameSetting)
		{
		...
		{
			ET.Log.Debug($"SetCurrentPlaceIndex:{playerIndex}");
			CurrentPlaceIndex = GetPlaceIndex(playerIndex);
			ET.Log.Debug($"CurrentPlaceIndex:{CurrentPlaceIndex}");
		...
		public void PreDrawTile(List<Tile> SelectDraw)
		{
			this.LocalSelectHandTiles = SelectDraw;
			NotifyObservers();
		}
		...
		public void ClearSelectTiles()
		{
			LocalSelectHandTiles = null;
			NotifyObservers();
		}
