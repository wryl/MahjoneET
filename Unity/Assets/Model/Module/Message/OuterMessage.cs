...
//通知玩家准备开始
	...
	[Message(OuterOpcode.GameSettingBack)]
	[ProtoContract]
	public partial class GameSettingBack
	{
		[ProtoMember(1)]
		public Mahjong.Model.GameMode GameMode { get; set; }
		...
		[ProtoMember(4)]
		public Mahjong.Model.MinimumFanConstraintType MinimumFanConstraintType { get; set; }

		[ProtoMember(5)]
		public Mahjong.Model.PointsToGameEnd PointsToGameEnd { get; set; }

		[ProtoMember(6)]
		public bool GameEndsWhenAllLastTop { get; set; }
		...
		[ProtoMember(10)]
		public Mahjong.Model.InitialDoraCount InitialDoraCount { get; set; }

		[ProtoMember(11)]
		public bool AllowRichiWhenPointsLow { get; set; }

		[ProtoMember(12)]
		public bool AllowRichiWhenNotReady { get; set; }

		[ProtoMember(13)]
		public bool AllowDiscardSameAfterOpen { get; set; }

		[ProtoMember(14)]
		public int RichiMortgagePoints { get; set; }

		[ProtoMember(15)]
		public int ExtraRoundBonusPerPlayer { get; set; }

		[ProtoMember(15)]
		public int NotReadyPunishPerPlayer { get; set; }
